...
const UpdateABusinessController = (req, res) => {
    const {
        businessName,
        category,
        email,
    ...
    ConnectToDatabase.query(`UPDATE businesses SET
        ...
        state='${state}',
        country='${country}'
        WHERE business_id='${requestBusinessId}'`)
        .then(() => SendResponse(
            res,
            200,
            'Business details updated!'
        ))
        .catch(() => SendResponse(res, 500, 'There was an error updating business'));
};

export default UpdateABusinessController;
